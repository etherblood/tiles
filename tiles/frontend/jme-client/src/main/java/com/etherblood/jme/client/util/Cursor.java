...
public class Cursor extends JmeCursor {
     ...
     *
     * @param tex cursor texture
     * @param hotspotx x position of the hotspot (click area)
     * @param hotspoty y position of the hotspot (click area)
     */
    public Cursor(Texture tex, int hotspotx, int hotspoty) {
        this(tex, hotspotx, hotspoty, 1);
    }
     ...
     */
    public Cursor(Texture tex, int hotspotx, int hotspoty, int frames) {
        if (frames < 1) {
